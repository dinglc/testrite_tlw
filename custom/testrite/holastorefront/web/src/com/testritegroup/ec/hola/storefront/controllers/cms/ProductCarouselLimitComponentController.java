...
import com.testritegroup.ec.core.model.cms2.components.ProductCarouselLimitComponentModel;
 ...
 */
@Controller("ProductCarouselLimitComponentController")
@Scope("tenant")
@RequestMapping(value = ControllerConstants.Actions.Cms.ProductCarouselLimitComponent)
public class ProductCarouselLimitComponentController extends AbstractCMSComponentController<ProductCarouselLimitComponentModel>
{
	...
	protected void fillModel(final HttpServletRequest request, final Model model,
			final ProductCarouselLimitComponentModel component)
	{
	...
	protected List<ProductData> collectLinkedProducts(final ProductCarouselLimitComponentModel component)
	{
		final List<ProductData> products = new ArrayList<>();
	...
	protected List<ProductData> collectSearchProducts(final ProductCarouselLimitComponentModel component)
	{
