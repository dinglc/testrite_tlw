 ...
 */
@Controller("HotProductComponentController")
@Scope("tenant")
@RequestMapping(value = ControllerConstants.Actions.Cms.HotProductComponent)
public class HotProductComponentController extends AbstractCMSComponentController<HotProductComponentModel>
{
	...
	@Override
	protected void fillModel(final HttpServletRequest request, final Model model, final HotProductComponentModel component)
	{
	...
	protected List<ProductData> collectLinkedProducts(final HotProductComponentModel component)
	{
		final List<ProductData> products = new ArrayList<>();
	...
	protected List<ProductData> collectSearchProducts(final HotProductComponentModel component)
	{
